		...
		<div class="container px-4 px-lg-5 mt-5">
			<div class="row">
				<div class="col h2 fw-bold">
					레시피 목록 <a href="/recipe/register.do?bookId=${bookId}" class="btn btn-md btn-warning">레시피 등록</a>
				</div>
			</div>
								...
								<div class="card h-70">
									...
									<div class="card-body p-4">
										<div class="text-center">
											...
											<!-- 요리시간, 난이도 -->
											(${RecipeList.recipeTime} / 난이도 : ${RecipeList.recipeLevel})
										</div>
										<div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
											<div class="text-center">
												<a class="btn btn-md btn-warning"
													href="/recipe/detail.do?bookId=${RecipeList.bookId}">요리책 상세보기
												</a>
											</div>
										</div>
									</div>
