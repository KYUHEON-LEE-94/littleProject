		...
		<div class="container">
			<div class="row">
				<div class="col-lg-9">
					...
					<!-- recipe Form -->
					<form class="row g-3" action="/recipe/register.do" method="post"
						...
						<div class="col-md-6">
							<label for="writer_name" class="form-label">등록정보</label> <input
								type="text" class="form-control" id="user_id"
								value="${cookie.loginid.value}" disabled> <input
						...
						<div class="col-12">
							...
							<textarea class="form-control" rows="5" id="ingredients"
								name="ingredients" placeholder="ex) 파,물, 된장 .."></textarea>
						</div>
